...
background("black");
 ...
 bg = createSprite(displayWidth/2,displayHeight/2,1100,500);
 ...
 iGround = createSprite(displayWidth/2,displayHeight/2+200,1100,25);
...
function plants(){
    ...
    if(frameCount % 80===0){
     ...
     plant2 = createSprite(displayWidth/2,displayHeight/2+150,10,10);
